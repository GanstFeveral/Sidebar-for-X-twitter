...
"📌" вызывает панель для хранения ссылок. Здесь вы можете создать теги, текст, ссылки и поместить всё это в разделы, которые можно открывать или закрывать по клику на их название. Панель растягивается по клику на границу слева.<br><br>
