...
3. После установки нажмите в браузере на иконку Tampermonkey и выберите "Создать новый скрипт".
4. В октрывшееся окно вставьте код из актуальной версии "x-sidebar.js" и нажмите Ctrl+S или Файл > Сохранить.
5. Всё готово!

# Важно

Данные скрипта хранятся в хранилище Tampermonkey, так что очистка cookies не удалит ваши данные. Но на всякий случай я настоятельно рекомендую пользоваться экспортом (кнопка внизу X Sidebar) для сохранения ваших данных перед определёнными манипуляциями с браузером. Также вы можете настроить экспорт ваших закладок в облако с помощью Tampermonkey (выбор облака настраивается в закладке "Утилиты").
