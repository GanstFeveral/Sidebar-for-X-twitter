...
"📌" вызывает панель, где вы можете складировать ссылки, теги, обычный текст, распределять по разделам, которые можно скрывать/открывать, как папку. Панель можно потянуть за левую границу и выбрать нужную вам ширину.

"🎨" добавляет фон вашему X. Этот фон кроме вас никто не увидит, но зато вы сможете персонализировать страничку лично под себя и получать удовольствие от красивого фона при использовании X. Встроенных настроек по установке фона должно быть достаточно, чтобы вы добились нужного эффекта от выбранной картинки.

"🔄" включает автоматическое обновление ленты каждые 10 секунд. Учтите, что функция работает только на НЕ активных страницах браузера. Это важно для тех, кто читает X во втором мониторе и не хочет вручную обновлять ленту каждый раз, когда появляются новые сообщения.

"✂️" вырезает левую панель с навигацией твиттера, если экран браузера уменьшается до минимальных масштабов.

"⇄" переносит данные из одного раздела в другой или быстро перемещает данные внутри раздела.

"✎" редактирует название и изменяет адрес ссылки.
...
Вы можете потерять все ваши закладки если:
