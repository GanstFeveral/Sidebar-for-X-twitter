...
"📌" вызывает панель для ссылок. Создавайте ссылки, теги, текст и разделы, которые можно открывать или закрывать по клику на название. Панель растягивается по клику на границу слева.
"🎨" добавляет фон вашему X.
"🔄" включает автоматическое обновление ленты каждые 10 секунд (работает только когда окно браузера становится НЕ активным).
